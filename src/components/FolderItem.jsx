    ...
    return (
        <Link className='text-inherit' to={`/folder/${folder.id}`}>
            <div className='flex flex-col space-y-2 justify-start items-center'>
                <svg className="w-8 md:w-16 h-8 md:h-20 text-amber-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
