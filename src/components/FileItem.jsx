...
function FileItem({ file }) {
    return (
        <div className='flex flex-col space-y-2 justify-start items-center'>
            {file.type === 'pdf' ? (
                <svg className="w-8 md:w-16 h-8 md:h-20 text-red-700 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                ...
                <svg className="w-8 md:w-16 h-8 md:h-20 text-green-700 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20">
                ...
                <svg className="w-8 md:w-16 h-8 md:h-20 text-blue-600 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20">
                    <path d="M5 5V.13a2.96 2.96 0 0 0-1.293.749L.879 3.707A2.98 2.98 0 0 0 .13 5H5Z" />
